...
namespace PrimeQueryWP8.Resources;
...
begin
    if System.Object.ReferenceEquals(resourceMan, nil) then begin
        var temp: System.Resources.ResourceManager := new System.Resources.ResourceManager('PrimeQueryWP8.Resources.AppResources', typeOf(AppResources).Assembly);
        resourceMan := temp;
    end;
    exit(resourceMan);
end;
